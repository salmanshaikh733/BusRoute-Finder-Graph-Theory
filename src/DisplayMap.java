...
public class DisplayMap extends JFrame {
  ...
  /* ============================= */
  public DisplayMap(String mapFile) {
  /* ============================= */
    ...
    try {
      ...
      busChanges = Integer.parseInt(st.nextToken());
...
/* ================================================================= */
  ...
  /* ========================================================== */
  private void drawLine(int u1, int v1) {
  /* ========================================================== */
  /* Input: edge (uv) */
  ...
  /* ==================================== */
  public void drawLine (GraphNode u, GraphNode v) {
  /* ==================================== */
      if (u != v) drawLine(u.getName(),v.getName());
  }
}
